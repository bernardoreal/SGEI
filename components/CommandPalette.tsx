...
import { Search, Calendar, Users, Settings, LogOut, ArrowRight, Moon, Sun } from 'lucide-react';
                ...
                <div className="space-y-1">
                  {filteredActions.map((action, idx) => (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-500/20 text-left transition-colors group"
                    >
                      <div className="flex items-center gap-3 text-slate-700 dark:text-slate-300 group-hover:text-indigo-700 dark:group-hover:text-indigo-300">
                        <div className="p-2 bg-slate-100 dark:bg-slate-700 rounded-lg group-hover:bg-indigo-100 dark:group-hover:bg-indigo-500/30 transition-colors">
                          {action.icon}
                        </div>
